...
interface LevelManagerProps {
  levels: Level[];
  onCommissionUpdate: (level: number, commission: number) => void;
}
          ...
          <CardContent className="p-4">
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <Label htmlFor={`commission-${levelData.level}`} className="text-sm">
                  Commission (%)
                </Label>
                <Input
                  id={`commission-${levelData.level}`}
                  type="number"
                  min="0"
                  max="100"
                  step="0.1"
                  ...
                  onChange={(e) => onCommissionUpdate(levelData.level, Number(e.target.value))}
